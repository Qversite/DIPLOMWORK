        ...
        <div class="part_bottom">
            ...
            <?php
                ...
                foreach ($studentData as $student){
                    ...
                    if($role) {
                        echo "<a onclick='toggleAddStudentBlock()' class='add_things'>Добавить ученика</a>";
                        echo "<a onclick='toggleDeleteGroup()' class='add_things'>Удалить класс</a>";
                    }
                    echo "</div></details>";
                }
                if($role){
                    echo '<a onclick="toggleAddGroupBlock()" class="groupAdd">Добавить класс</a>';
                }
            ?>
            </aside>
        </div>
    ...
    <div id="addGroupBlock" class="add-block">
        <form action="functions.php" method="post" class="form-add">
            <div class="form-group">
                <label for="groupName">Название класса:</label>
                <input type="text" id="groupName" name="group_name" required>
            </div>
            <div>
            <button type="submit" name="submit_group">Добавить класс</button>
...
<script>
    function confirmDeleteStudent(link) {
        ...
        var confirmDelete = confirm('Вы уверены, что хотите удалить ученика? ');
        if (confirmDelete) {
